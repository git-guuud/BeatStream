...
INSERT INTO artists (id, wallet_address, ens_name, display_name) VALUES
  ('a1000000-0000-0000-0000-000000000001'::uuid, '0x1111111111111111111111111111111111111111', 'synthwave.beatstream.eth', 'SynthWave'),
  ('a1000000-0000-0000-0000-000000000002'::uuid, '0x2222222222222222222222222222222222222222', 'neonbeats.beatstream.eth', 'NeonBeats'),
  ('a1000000-0000-0000-0000-000000000003'::uuid, '0x3333333333333333333333333333333333333333', 'lofiking.beatstream.eth', 'LoFi King')
ON CONFLICT DO NOTHING;

-- Seed tracks
INSERT INTO tracks (id, artist_id, title, duration_seconds, chunks, is_private) VALUES
  ('e1000000-0000-0000-0000-000000000001'::uuid, 'a1000000-0000-0000-0000-000000000001'::uuid, 'Midnight Drive', 180, 36, false),
  ('e1000000-0000-0000-0000-000000000002'::uuid, 'a1000000-0000-0000-0000-000000000001'::uuid, 'Neon Skyline', 210, 42, true),
  ('e1000000-0000-0000-0000-000000000003'::uuid, 'a1000000-0000-0000-0000-000000000002'::uuid, 'Electric Dreams', 195, 39, true),
  ('e1000000-0000-0000-0000-000000000004'::uuid, 'a1000000-0000-0000-0000-000000000003'::uuid, 'Rainy Afternoon', 240, 48, false),
  ('e1000000-0000-0000-0000-000000000005'::uuid, 'a1000000-0000-0000-0000-000000000003'::uuid, 'Coffee Shop Vibes', 165, 33, true)
ON CONFLICT DO NOTHING;
